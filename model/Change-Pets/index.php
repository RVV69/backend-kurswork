...
<head>
    ...
    <link href="/model/Change-Pets/style.css" rel="stylesheet">
        ...
        <div class="table-scroll-wrapper">
            <table class="change-table" border="1">
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><a href='/controllers/change-info/change-pets/edit.php?id=" . $row['id'] . "'>Редагувати</a> |
                        <a href='/controllers/change-info/delete-pets/delete.php?id=" . $row['id'] . "'>Видалити</a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
            <br>
            <a href="/controllers/change-info/add-pets/add.php">Додати новий запис</a><br>
        </div>
    </main>
