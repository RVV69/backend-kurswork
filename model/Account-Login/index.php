...
<head>
    ...
    <link href="/model/Account-Login/style.css" rel="stylesheet">
        ...
        <?php
            ...
            ?>
                <div class="account-wrapper">
                    <h2 class="text-align-center">Привіт користувач, введіть ваш логін та пароль будь ласка!</h2>
                    <form class="form-styles login-form" method="post" action="/controllers/autorize/login.php">
                        <input placeholder="Логін" type="text" name="name" required>
